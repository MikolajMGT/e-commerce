            ...
            <div className="mt-5 entries">
                ...
                <div className="p-4">
                    <h4 className="summary"
                        style={{marginLeft: '51vw', display: 'inline'}}>Total: {calculateTotal().toFixed(2)} PLN</h4>
                    <Button style={{height: '40px', borderRadius: '20px'}} variant="contained" color="secondary"
